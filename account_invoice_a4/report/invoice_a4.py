...
class account_invoice_a4(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(account_invoice_a4, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw(
    'report.account.invoice.a4',
    'account.invoice',
    'addons/account_invoice_a4/report/invoice_a4.rml',
    parser=account_invoice_a4,
    header=False,
)
