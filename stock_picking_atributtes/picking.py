...
class stock_picking(osv.osv):
    ...
    _columns = {
        ...
        #agregado para verificar las cantidades de un picking de interno
        'verificado': fields.boolean('Verificado', readonly=True),
        }
...
class stock_picking_out(osv.osv):
    ...
    _columns = {
        'bultos': fields.integer('Bultos'),
        'peso': fields.float('Peso',digits=(2,1)),
        # agregado para verificar las cantidades de un picking de envio
        'verificado': fields.boolean('Verificado',readonly=True),
        }
