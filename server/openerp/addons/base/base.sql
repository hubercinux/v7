...
insert into res_partner (id, name, lang, company_id) VALUES (1, 'KIDDYS HOUSE SAC', 'en_PE', 1);
insert into ir_model_data (name,module,model,noupdate,res_id) VALUES ('main_partner','base','res.partner',true,1);

insert into res_currency (id, name) VALUES (1, 'PEN');
insert into ir_model_data (name,module,model,noupdate,res_id) VALUES ('PEN','base','res.currency',true,1);

insert into res_company (id, name, partner_id, currency_id) VALUES (1, 'KIDDYS HOUSE SAC', 1, 1);
