...
class purchase_order(osv.osv):
    ...
    _columns = {
        ...
        'amount_untaxed': fields.function(_amount_all, digits_compute= dp.get_precision('PriceTax'), string='Untaxed Amount',
            store={
                'purchase.order.line': (_get_order, None, 10),
            }, multi="sums", help="The amount without tax", track_visibility='always'),
        'amount_tax': fields.function(_amount_all, digits_compute= dp.get_precision('PriceTax'), string='Taxes',
            store={
                'purchase.order.line': (_get_order, None, 10),
            }, multi="sums", help="The tax amount"),
        'amount_total': fields.function(_amount_all, digits_compute= dp.get_precision('PriceTax'), string='Total',
            store={
                'purchase.order.line': (_get_order, None, 10),
...
class purchase_order_line(osv.osv):
    ...
    _columns = {
        ...
        'price_unit': fields.float('Unit Price', required=True, digits_compute= dp.get_precision('PrecioCompra')),
        'price_subtotal': fields.function(_amount_line, string='Subtotal', digits_compute= dp.get_precision('PrecioCompra')),
