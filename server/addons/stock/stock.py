...
class stock_picking(osv.osv):
    ...
    _columns = {
        ...
        'move_lines': fields.one2many('stock.move', 'picking_id', 'Internal Moves', states={'done': [('readonly', True)], 'cancel': [('readonly', True)], 'auto': [('readonly', True)], 'confirmed': [('readonly', True)],'assigned': [('readonly', True)]}),
...
class stock_move(osv.osv):
    ...
    _columns = {
        ...
        'price_unit': fields.float('Unit Price', digits_compute= dp.get_precision('PrecioCosto'), help="Technical field used to record the product cost set by the user during a picking confirmation (when average price costing method is used)"),
